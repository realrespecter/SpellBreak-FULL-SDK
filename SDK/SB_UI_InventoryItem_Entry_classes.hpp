...
#include "SB_UI_InventoryItem_Entry_structs.hpp"
...
// WidgetBlueprintGeneratedClass UI_InventoryItem_Entry.UI_InventoryItem_Entry_C
// 0x0028 (0x0268 - 0x0240)
class UUI_InventoryItem_Entry_C : public UGItemWidget
{
public:
	...
	class UBorder*                                     RarityBorder;                                             // 0x0250(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_InventoryItem_Entry.UI_InventoryItem_Entry_C");
		return ptr;
	}
