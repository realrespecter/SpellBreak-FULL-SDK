...
#include "SB_CinematicCamera_structs.hpp"
...
public:
	...
	class FString                                      DefaultFilmbackPresetName;                                // 0x08C0(0x0010) (ZeroConstructor, Config)
	class FString                                      DefaultLensPresetName;                                    // 0x08D0(0x0010) (ZeroConstructor, Config)
