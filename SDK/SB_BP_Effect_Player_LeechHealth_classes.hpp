...
#include "SB_BP_Effect_Player_LeechHealth_structs.hpp"
...
// BlueprintGeneratedClass BP_Effect_Player_LeechHealth.BP_Effect_Player_LeechHealth_C
// 0x0018 (0x0208 - 0x01F0)
class UBP_Effect_Player_LeechHealth_C : public UGGameplayEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Effect_Player_LeechHealth.BP_Effect_Player_LeechHealth_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Effect_Player_LeechHealth(int EntryPoint);
};
