...
#include "SB_UI_Core_Button_CloseIcon_BlackBG_Comp_structs.hpp"
...
// WidgetBlueprintGeneratedClass UI_Core_Button_CloseIcon_BlackBG_Comp.UI_Core_Button_CloseIcon_BlackBG_Comp_C
// 0x0010 (0x0548 - 0x0538)
class UUI_Core_Button_CloseIcon_BlackBG_Comp_C : public UGButton
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Core_Button_CloseIcon_BlackBG_Comp.UI_Core_Button_CloseIcon_BlackBG_Comp_C");
		return ptr;
	}
