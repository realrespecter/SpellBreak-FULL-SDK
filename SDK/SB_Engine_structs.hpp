...
#include "SB_Slate_classes.hpp"
#include "SB_PacketHandler_classes.hpp"
...
enum class ERawCurveTrackTypes : uint8_t
{
	...
	ERawCurveTrackTypes__RCT_BakedTransform = 3,
	ERawCurveTrackTypes__RCT_BakedVector = 4,
	ERawCurveTrackTypes__RCT_MAX   = 5
};
...
struct FRawCurveTracks
{
	...
	TArray<struct FTransformCurve>                     BakedTransformCurves;                                     // 0x0010(0x0010) (ZeroConstructor)
	TArray<struct FVectorCurve>                        BakedVectorCurves;                                        // 0x0020(0x0010) (ZeroConstructor)
};
...
// ScriptStruct Engine.ExponentialHeightFogInterpParams
// 0x0038
struct FExponentialHeightFogInterpParams
{
	...
	struct FLinearColor                                FogInscatteringColor;                                     // 0x0004(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	float                                              DirectionalInscatteringExponent;                          // 0x0014(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              DirectionalInscatteringStartDistance;                     // 0x0018(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                DirectionalInscatteringColor;                             // 0x001C(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	float                                              FogHeightFalloff;                                         // 0x002C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              FogMaxOpacity;                                            // 0x0030(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              StartDistance;                                            // 0x0034(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
};
...
struct FMeshMergingSettings
{
	...
	bool                                               bAllowDistanceField;                                      // 0x00BD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bExportNormalMap;                                         // 0x00BE(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bExportMetallicMap;                                       // 0x00BF(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bExportRoughnessMap;                                      // 0x00C0(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bExportSpecularMap;                                       // 0x00C1(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
struct FHierarchicalSimplification
{
	...
	struct FMeshMergingSettings                        MergeSetting;                                             // 0x00C8(0x00CC) (Edit)
	float                                              DesiredBoundRadius;                                       // 0x0194(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DesiredFillingPercentage;                                 // 0x0198(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MinNumberOfActorsToBuild;                                 // 0x019C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOnlyGenerateClustersForVolumes;                          // 0x01A0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
